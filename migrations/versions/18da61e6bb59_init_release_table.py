...
def upgrade():
    ...
    op.bulk_insert(release_table, [
        {'name': 'Core Set', 'is_phg': True, 'is_promo': False},
        {'name': 'The Frostdale Giants', 'is_phg': True, 'is_promo': False},
        {'name': 'The Children of Blackcloud', 'is_phg': True, 'is_promo': False},
        {'name': 'The Roaring Rose', 'is_phg': True, 'is_promo': False},
        {'name': 'The Duchess of Deception', 'is_phg': True, 'is_promo': False},
        {'name': 'The Laws of Lions', 'is_phg': True, 'is_promo': False},
        {'name': 'The Song of Soaksend', 'is_phg': True, 'is_promo': False},
        {'name': 'The Masters of Gravity', 'is_phg': True, 'is_promo': False},
        {'name': 'The Path of Assassins', 'is_phg': True, 'is_promo': False},
        {'name': 'The Goddess of Ishra', 'is_phg': True, 'is_promo': False},
        {'name': 'The Boy Among Wolves', 'is_phg': True, 'is_promo': False},
        {'name': 'The Demons of Darmas', 'is_phg': True, 'is_promo': False},
        {'name': 'The Spirits of Memoria', 'is_phg': True, 'is_promo': False},
        {'name': 'The Ghost Guardian', 'is_phg': True, 'is_promo': False},
        {'name': 'The King of Titans', 'is_phg': True, 'is_promo': False},
        {'name': 'The Protector of Argaia', 'is_phg': True, 'is_promo': False},
        {'name': 'The Grave King', 'is_phg': True, 'is_promo': False},
