"""Fiona and James cards

Revision ID: 5afab7189e03
Revises: 286ac25d59ba
Create Date: 2019-01-11 15:00:10.082706
...
def upgrade():
    # Import new Fiona and James cards
    my_dir = os.path.dirname(os.path.realpath(__file__))
    with open(os.path.join(my_dir, '../data/5afab7189e03_fiona_james.json'), 'r') as f:
        data = json.load(f)
    inserts = []
    stubs = []
