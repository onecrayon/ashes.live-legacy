"""Harold and Sembali cards

Revision ID: c3d83a74b9b1
Revises: 8bc752a0e12a
Create Date: 2018-07-05 14:53:54.496630
...
revision = 'c3d83a74b9b1'
down_revision = '8bc752a0e12a'
branch_labels = None
depends_on = None


def upgrade():
    # Import new Harold and Sembali cards
    my_dir = os.path.dirname(os.path.realpath(__file__))
    with open(os.path.join(my_dir, '../data/c3d83a74b9b1_harold_sembali.json'), 'r') as f:
        data = json.load(f)
    inserts = []
    stubs = []
